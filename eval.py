"""
Evaluate the trained congestion model on the validation set.
Reports the three standard CircuitNet congestion metrics:
  - NRMS    (normalized RMSE)        lower is better
  - SSIM    (structural similarity)  higher is better, 0..1
  - Pearson (correlation)            higher is better, -1..1
"""
import torch
...
def _gauss_win(ks=11, sigma=1.5, device="cpu"):

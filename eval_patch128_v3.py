"""
Evaluate the overlapping-patch (stride=64) 7-channel model.
For comparison:
  Non-overlapping (v2) -> Pearson 0.3107
  Overlapping (v3)      -> ?
"""
import torch
...
from train_patch128_v3 import PatchCircuitNet, ResUNetSE, DEVICE, IN_FEATS
...
def main():
    ...
    net.load_state_dict(torch.load(Path.home() / "vlsi-project/unet_patch128_v3.pt",
    ...
    print(f"\nPATCH128_V3 (overlap) MODEL  ->  NRMS {avg_nrms:.4f}  "
